          ...
          <div id="collapseMenu"
            ...
            <ul
              ...
              <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3"><a href='javascript:void(0)'
                class="hover:text-blue-600 text-[15px] font-semibold text-blue-600 block">Trang trủ</a></li>
              <li class="group max-lg:border-b max-lg:border-gray-300 max-lg:py-3 relative">
                <a href='javascript:void(0)'
                  class="hover:text-blue-700 text-gray-600 text-[15px] font-semibold lg:hover:fill-blue-700 block">Sản phẩm<svg
                ...
                <ul
                  ...
                  <li class="border-b border-gray-300 py-2"><a href='javascript:void(0)'
                    class="hover:text-blue-700 text-gray-600 text-[15px] font-medium block">Cốc giấy</a></li>
                  <li class="border-b border-gray-300 py-2"><a href='javascript:void(0)'
                    class="hover:text-blue-700 text-gray-600 text-[15px] font-medium block">Cốc nhựa</a></li>
                  <li class="border-b border-gray-300 py-2"><a href='javascript:void(0)'
                    class="hover:text-blue-700 text-gray-600 text-[15px] font-medium block">Tô giấy</a></li>
                  <li class="border-b border-gray-300 py-2"><a href='javascript:void(0)'
                    class="hover:text-blue-700 text-gray-600 text-[15px] font-medium block">Phụ kiện đi kèm</a></li>
                </ul>
              </li>
              <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3"><a href='javascript:void(0)'
                class="hover:text-blue-700 text-gray-600 text-[15px] font-semibold block">Tư vấn</a></li>
              <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3"><a href='javascript:void(0)'
                class="hover:text-blue-700 text-gray-600 text-[15px] font-semibold block">Liên hệ</a></li>
            </ul>
          </div>
